...
namespace Blog.Tests.Unit.Application.Queries.UserQueries
{
    public class GetFollowedQueryHandlerTests
    {
        ...
        {
            var userFollower = new User("email", "username", "password", true, "User", "url");
            var user1 = new User("email1", "username1", "password1", true, "User", "url");
            var user2 = new User("email2", "username2", "password2", true, "User", "url");
