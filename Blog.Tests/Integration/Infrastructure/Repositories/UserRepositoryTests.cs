...
namespace Blog.Tests.Integration.Infrastructure.Repositories
{
    public class UserRepositoryTests
    {
        ...
        public async Task GetUserByEmailAndPasswordAsync_Should_Return_User_If_Exists()
        {
            ...
            {
                var user = new User(1, "Fulano", "test@example.com", "hashedpassword", true, "User", "path");
        ...
        public async Task GetByIdWithFollowedAsync_Should_Return_User_With_Followed()
        {
            using (var context = new TestDbContext(_options))
            {
                var user1 = new User(1, "Fulano", "email1", "hash", true, "User", "path");
                var user2 = new User(2, "Fulano", "email2", "hash", true, "User", "path");
                var user3 = new User(3, "Fulano", "email3", "hash", true, "User", "path");
        ...
        public async Task GetFollowersAsync_Should_Return_Followers_For_Specific_User()
        {
            using (var context = new TestDbContext(_options))
            {
                var user1 = new User(1, "Fulano 1", "email1", "hash", true, "User", "path");
                var user2 = new User(2, "Fulano 2", "email2", "hash", true, "User", "path");
                var user3 = new User(3, "Fulano 3", "email3", "hash", true, "User", "path");
        ...
        public async Task GetFollowedAsync_Should_Return_Followed_For_Specific_User()
        {
            ...
            {
                var user1 = new User(1, "Fulano", "email1", "hash", true, "User", "path");
                var user2 = new User(2, "Fulano", "email1", "hash", true, "User", "path");
                var user3 = new User(3, "Fulano", "email1", "hash", true, "User", "path");
