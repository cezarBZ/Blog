    ...
    public class RepositoryTests
    {
        ...
        public async Task AddAsync_Should_Add_Entity_To_Database()
        {
            using (var context = new TestDbContext(_options))
            {
                ...
                var user = new User(1, "John Doe", "email", "senha", true, "User", "path");
        ...
        public async Task GetAllAsync_Should_Return_All_Entities()
        {
            ...
            {
                var repository = new Repository<User, int>(context);
                await repository.AddAsync(new User(1, "John Doe", "email", "senha", true, "User", "path"));
                await repository.AddAsync(new User(2, "Jane Doe", "email", "senha", true, "User", "path"));
                await context.SaveChangesAsync();
